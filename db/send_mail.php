...
include('ip.php');
    $mailto = $email;
    $mailSub = "New Login Notification";
	$message="
                                    ...
                                    <td align='left' style='color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;'>
                                        <!-- section text ======-->
										 <p style='line-height: 24px; margin-bottom:20px;'>
                                            Your ideaBook Account Login Justnow.
                                        </p>
<p style='line-height: 24px; margin-bottom:15px;'>

                                            <b>Hi,</b>,<br>
											We detected a login into your account from...

                                        </p>
                                        <p style='line-height: 24px; margin-bottom:15px;'>

                                            <b>IP Address :</b>".$MyipAddress."<br>
                                            <b>Browser :</b>".$browser." -".$browser_version."<br>
										...
										<p style='line-height: 24px; margin-bottom:15px;'>
                                         ...
                                         If this is not you, please ensure your account security as soon as possible. 
