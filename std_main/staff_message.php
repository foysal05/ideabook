...
<script type="text/javascript" src="http://code.jquery.com/ui/1.10.1/jquery-ui.min.js"></script>	
   ...
   <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="timeline.php">Timeline</a></li>
			...
			<li class="active"><a href="message.php?std">Message</a></li>
  ...
  <button type="button" class="btn btn-primary"><a style="color:white;" href="message.php">Student</a></button>
        ...
        <div class="panel panel-default ">
            <div class="panel-heading">
                <h3 class="panel-title">University Staff List</h3>
            </div>
            <div class="panel-body" style="max-height:500px; overflow-y: scroll; overflow-x:hidden;">
				<div class="table-container">
                    <table class="table-users table" border="0">
						...
						$query="select * from users INNER JOIN staff on users.uid=staff.s_id INNER JOIN department on staff.department_id=department.d_id where users.uid !='".$_SESSION['id']."' ";
						...
						?>
                            <tr>
                                ...
                                <td align="center">
                                   <?php
								   echo "<button type='submit' name='details' class='btn btn-info '><i class='fa fa-comment'></i><a style='color:white' href='staff_message.php?operation=select&std_id=".$row['s_id']."&name=".$row['first_name']."'>Message</button>";
