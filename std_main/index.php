...
<a class="navbar-brand" href="index">ideaBook</a>
</div>
<style>
...
<div class="col-sm-3 sidenav">
  ...
  <!--<div class="panel panel-default">
    ...
    <img src="../image/ib.png"  style="width: 100%; height: auto;">
	</div>
  </div>
-->
...
?>     
	...
	$results_per_page = 5;	
$query  = "SELECT * FROM  `idea` where idea_status='Active'"; 
...
$query  = "SELECT * FROM  `idea` INNER JOIN category on idea.category_id=category.c_id INNER JOIN users on idea.idea_author_id=users.uid where idea_status='Active'   order by idea.id DESC LIMIT " . $this_page_first_result . ',' .  $results_per_page; 
$res    = mysqli_query($connection,$query);
			...
			if(isset($_GET['btncom'])){
				...
				$query="SELECT user_type from  users where uid='$author'";
					...
					if($user_type=='STD'){
						//echo $email;
						//echo $anonymous;
						//If any student submit comment then idea author can receive an email
...
<li><a href="password_change">Account Setting</a></li>
