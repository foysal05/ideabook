...
<?php include('header_top.php');?>
 ...
 <!-- general form elements -->
  ...
  <ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#home">Latest Comments</a></li>
    <li><a data-toggle="tab" href="#menu1">Idea With Comment</a></li>
    <li><a data-toggle="tab" href="#menu2">Idea Without Comment</a></li>
   
    <li><a data-toggle="tab" href="#menu3">Anonymous Comments</a></li>
  </ul>
  ...
  <div class="tab-content">
   ...
   <div id="menu2" class="tab-pane fade">
    ...
    <div id="menu3" class="tab-pane fade">
      ...
      <?php include('anonymous_comments.php');?>
    </div>
  </div>
</div>
