...
*/
$DBcon=mysqli_connect('localhost','root','','ewsd')
$student_name=$_POST['student_name'];
$student_roll_no=$_POST['student_roll_no'];
$student_class=$_POST['student_class'];

$stmt = $DBcon->prepare("INSERT INTO category(name,closure_date,final_closure_date) VALUES(:student_name, :student_roll_no,:student_class)");
