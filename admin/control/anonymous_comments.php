<div class="box-body" style="max-height:auto; max-width:90%; overflow-y: hidden; overflow-x:scroll;">
            <table id="example1" class="table table-bordered table-striped">
				...
				$query="SELECT * from comment INNER JOIN users on comment.comment_author_id=users.uid INNER JOIN idea on comment.idea_id=idea.id where comment.anonymous='Anonymous'";
