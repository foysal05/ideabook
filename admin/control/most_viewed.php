<div class="box-body" style="max-height:auto; max-width:90%; overflow-y: hidden; overflow-x:scroll;">
            <table id="example3" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
				$query="SELECT MAX(counted),idea_id FROM(SELECT COUNT(v_id) as counted,idea_id FROM VIEW as v INNER JOIN idea as i on v.idea_id=i.id  GROUP BY v.idea_id ) as Top_Idea";
