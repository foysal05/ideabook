...
<?php include('left_nav.php');?>
 ...
 <!-- general form elements -->
  <div class ="row">
<?php
$query="select * from department where d_id !='0'";
					$result=mysqli_query($con,$query);
					if(mysqli_num_rows($result)>0){
						while($row=mysqli_fetch_array($result, MYSQLI_ASSOC)){
							
							echo "<div class ='col-md-6 col-sm-6'>
								<h2  class='alert alert-success'><a style='text-decoration:none' href='dep_student.php?operation=select&d_id=".$row['d_id']."'>".$row['d_name']." Department</a> </h2> 
		...
		<?php
		$d_id=$_GET['d_id'];
		$query="SELECT COUNT(id),idea_author_id,department_id from idea inner join users on idea.idea_author_id=users.uid inner join student on users.uid=student.std_id where department_id='$d_id' group by idea_author_id
";
					$result=mysqli_query($con,$query);
		...
		<div class="col-md-4">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?php echo $rowcount." Students";?></span>
...
$query="select * from department where d_id ='$d_id'";
$result=mysqli_query($con,$query);
					if(mysqli_num_rows($result)>0){
						while($row=mysqli_fetch_array($result, MYSQLI_ASSOC)){
...
?>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $row['d_name'];?> Department Students List</h3>
            </div>
			<?php
			}
					}
